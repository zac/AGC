...
/// Dependency-free SHA-256 (FIPS 180-4) used to identify Luminary core images
/// in checkpoints. The AGC package builds on Linux CI where CryptoKit is not
/// available, so a fixed pure-Swift digest keeps checksums identical everywhere.
public enum AGCSHA256 {
    ...
    /// Lowercase hexadecimal digest of `data`.
